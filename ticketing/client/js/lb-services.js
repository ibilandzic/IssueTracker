  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Issue.messages.findById() instead.
        "prototype$__findById__messages": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Issues/:id/messages/:fk",
          method: "GET"
        },

        // INTERNAL. Use Issue.messages.destroyById() instead.
        ...
        // INTERNAL. Use Issue.messages.updateById() instead.
        ...
        // INTERNAL. Use Issue.messages() instead.
        "prototype$__get__messages": {
          isArray: true,
          url: urlBase + "/Issues/:id/messages",
          method: "GET"
        },

        // INTERNAL. Use Issue.messages.create() instead.
        "prototype$__create__messages": {
          url: urlBase + "/Issues/:id/messages",
          method: "POST"
        },

        // INTERNAL. Use Issue.messages.destroyAll() instead.
        "prototype$__delete__messages": {
          url: urlBase + "/Issues/:id/messages",
          method: "DELETE"
        },

        // INTERNAL. Use Issue.messages.count() instead.
        "prototype$__count__messages": {
          url: urlBase + "/Issues/:id/messages/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Message.issue() instead.
        "::get::Message::issue": {
          url: urlBase + "/Messages/:id/issue",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Issue.messages
     * @header lbServices.Issue.messages
     * @object
     * @description
     *
     * The object `Issue.messages` groups methods
     * manipulating `Message` instances related to `Issue`.
     *
     * Call {@link lbServices.Issue#messages Issue.messages()}
     ...
     */
        ...
        R.messages = function() {
          ...
          var action = TargetResource["::get::Issue::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Issue.messages#count
         * @methodOf lbServices.Issue.messages
         *
         * @description
         *
         * Counts messages of Issue.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.messages.count = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::count::Issue::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Issue.messages#create
         * @methodOf lbServices.Issue.messages
         *
         * @description
         *
        ...
        R.messages.create = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::create::Issue::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Issue.messages#createMany
         * @methodOf lbServices.Issue.messages
         *
         * @description
         *
        ...
        R.messages.createMany = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::createMany::Issue::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Issue.messages#destroyAll
         * @methodOf lbServices.Issue.messages
         *
         * @description
         *
        ...
        R.messages.destroyAll = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::delete::Issue::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Issue.messages#destroyById
         * @methodOf lbServices.Issue.messages
         *
         * @description
         *
        ...
        R.messages.destroyById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::destroyById::Issue::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Issue.messages#findById
         * @methodOf lbServices.Issue.messages
         *
         * @description
         *
        ...
        R.messages.findById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::findById::Issue::messages"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Issue.messages#updateById
         * @methodOf lbServices.Issue.messages
         *
         * @description
         *
        ...
        R.messages.updateById = function() {
          var TargetResource = $injector.get("Message");
          var action = TargetResource["::updateById::Issue::messages"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Issue.messages.createMany() instead.
        "::createMany::Issue::messages": {
          isArray: true,
          url: urlBase + "/Issues/:id/messages",
          method: "POST"
        },
    ...
    */
    R.modelName = "Message";
        ...
        R.issue = function() {
          ...
          var action = TargetResource["::get::Message::issue"];
          return action.apply(R, arguments);
        };
